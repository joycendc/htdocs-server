                    ...
                    <tbody>
                        ...
                        ?>
                            <a href="#showOrderModal" class="info" data-toggle="modal">
                                <tr class='order' data-target="#showOrderModal" data-toggle="tooltip" data-id="<?php echo $order["queue_id"]; ?>" data-name="<?php echo $order["customer_name"]; ?>" data-date="<?php echo $order["date"]; ?>" id="<?php echo $order["id"]; ?>">                          
                                    <td></td>
