                ...
                <table class="table table-hover ">
                    ...
                    <tbody>
                        <?php
                            ...
                            $orders = $db->query("SELECT id, date, queue_id, customer_id, customer_name, SUM(total) AS 'total' FROM transactions GROUP BY id, DATE_FORMAT(date,'%Y-%M-%d %H:%i') LIMIT $start, $limit;")->fetchAll();
                            ...
                            $sql = $db->query("SELECT count(id) AS id FROM transactions GROUP BY id, DATE_FORMAT(date,'%Y-%M-%d %H:%i');")->fetchAll();
