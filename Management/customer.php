                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <a href="#addCustomerModal" class="btn btn-success" data-toggle="modal"><i
                                class="fas fa-plus-circle"></i> <span>Add New Customer</span></a>
                    </div>
                </div>
         ...
         -->
                            ...
                            <td>
                                <a href="#editCustomerModal" class="edit" data-toggle="modal">
                                    <i class="fas fa-edit customerUpdate" data-toggle="tooltip"
                                        data-id="<?php echo $customer['id']; ?>" data-first_name="<?php echo $customer['first_name']; ?>"
                                        data-last_name="<?php echo $customer['last_name']; ?>" data-mobile_number="<?php echo $customer['mobile_number']; ?>"
                                        title="Edit"></i>
                                </a>
                                <a href="#deleteCustomerModal" class="customerDelete" data-id="<?php echo $customer['id']; ?>"
