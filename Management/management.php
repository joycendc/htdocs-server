							...
							<label for="checkbox2"></label>
								...
								<td>
									<a href="#editProductModal" class="edit" data-toggle="modal">
										<i class="fas fa-edit update" data-toggle="tooltip" data-id="<?php echo $product["id"]; ?>" data-name="<?php echo $product["name"]; ?>" data-desc="<?php echo $product["description"]; ?>" data-price="<?php echo $product["price"]; ?>" data-cat="<?php echo $product["cat_id"]; ?>" title="Edit"></i>
									</a>
									<a href="#deleteProductModal" class="delete" data-id="<?php echo $product["id"]; ?>" data-toggle="modal"><i class="fas fa-trash" data-toggle="tooltip" title="Delete"></i></a>
								</td>
							</tr>
					<?php
						}
